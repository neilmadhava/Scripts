...
for i in $(seq 1 $pages); do 
	...
	if [ $num_result != 1 ]; then
		echo "$results" | while read line; do
			img_link="https://ilarge.lisimg.com/image/$line/1080full-$celeb.jpg"
			if [ $img_link != "https://ilarge.lisimg.com/image/0/1080full-$celeb.jpg" ]; then
